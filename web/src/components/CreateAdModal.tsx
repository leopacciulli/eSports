...
export const CreateAdModal = () => {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="shadow-black/25 w-[480px] rounded-lg fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <Dialog.Title className="text-3xl font-black">Publique um anúncio</Dialog.Title>
        
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <label htmlFor="game" className="font-semibold">Qual o game?</label>
            <select name="game" className="bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none" id="game" placeholder="Selecione o game que deseja jogar" defaultValue="">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder="Tudo bem ser do ZERO" />
            </div>
            <div className="flex flex-col gap-2">
